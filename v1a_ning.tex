...
\title{Solar: stable and ultrafast variable selection for high dimensional and large-scale data\tnoteref{tstar}}
\tnotetext[tstar]{The authors would like to thank . . . .}
